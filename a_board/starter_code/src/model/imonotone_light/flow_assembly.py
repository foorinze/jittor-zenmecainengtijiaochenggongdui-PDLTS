...
官方 Light FlowAssembly 的 Jittor 版（与 pdlts_heavy/flow_assembly.py 同源，
原始移植源：PD-LTS 原始实现 models/model_light/deflow.py:337-340）。

命名说明：HeavyFlowAssembly 已更名为 IMonotoneFlowAssembly（反映实际语义——
