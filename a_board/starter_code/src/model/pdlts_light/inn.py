"""PDLTS Light 的 INN 组件（Jittor 移植 + 当前简化）

来源:
    - PD-LTS 原始实现 models/layers/act_norm.py  (ActNormNd/1d/2d)
    - PD-LTS 原始实现 models/layers/glow.py      (InvertibleLinear)
    - PD-LTS 原始实现 models/layers/container.py (SequentialFlow)
    - PD-LTS 原始实现 models/model_light/deflow.py (FlowAssembly)
...
class ActNorm1d(nn.Module):
    ...
    对应原仓库: PD-LTS 原始实现 models/layers/act_norm.py:9-86
...
class InvertibleLinear(nn.Module):
    ...
    对应原仓库: PD-LTS 原始实现 models/layers/glow.py:10-41
...
class SequentialFlow(nn.Module):
    """对应原仓库 PD-LTS 原始实现 models/layers/container.py:4-31。"""
...
class FlowAssembly(SequentialFlow):
    """对应原仓库 PD-LTS 原始实现 models/model_light/deflow.py:273-343。
